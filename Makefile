...
PKG_SOURCE_URL:=https://github.com/Ozzy-Ang/nf_deaf.git
PKG_SOURCE_DATE:=2026-01-08   # 替换为仓库实际提交日期
PKG_SOURCE_VERSION:=91fa845ef402404ad6d7eec6279d1612ae7b1e0d  # 替换为实际提交的哈希值（例如 `git rev-parse HEAD`）
